...
public class DateHelper {
    ...
    public static Calendar getStartOfCurrent(){
    	return getStartOf(Calendar.getInstance());
    }
    ...
    public static Calendar addDays(Calendar date, int offset){
        return addTime(date, Calendar.DAY_OF_MONTH, offset);
    }
    ...
    public static final String yyyy_MM_dd = datePattern;
	/**
	 * yyyyMMdd
	 */
    ...
    public static Calendar toCalendar(String s){
        return toCalendar(s, datePattern);
    }
